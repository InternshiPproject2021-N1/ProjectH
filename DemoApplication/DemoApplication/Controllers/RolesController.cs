...
namespace DemoApplication.Controllers
{
    public class RolesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RoleId,Name,Create,CreatedBy,Description")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RoleId,Name,Create,CreatedBy,Description")] Role role)
        {
            if (ModelState.IsValid)
            {
